...
public class ReadingCVS_FileFromTheTest {

    // Thi is to specify this test is now parameterized test
    @ParameterizedTest
    ...
    public void testingAddition(int num1, int num2, int result){

        System.out.println("num1 = " + num1);
        System.out.println("num2 = " + num2);
        System.out.println("additionalResult = " + result);

        // Used this import for assertThat() --> import static org.hamcrest.MatcherAssert.assertThat;
        assertThat(num1+num2, is(result));

        //For assertEquals() use this import --> import static org.junit.jupiter.api.Assertions.assertEquals;
        // If the assert fails, it will display the message "Wrong result!!!"
