...
public class SecureSpartanTest {
    ...
    public static int createRandomSpartan(){
        ...
        //use faker to get random first name, gender and 10 digit phone number
        ...
        Response response = given()
                                  .log().ifValidationFails() // Only log if anything fails
                                  .auth().basic("admin","admin")
        ...
        //use jsonPath() to get the id from response and return it out from the method
